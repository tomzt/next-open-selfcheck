...
namespace ISO14443Ap4_Transceive
{
    class rfidlib_aip_iso14443A
    {
        ...
        [DllImport("rfidlib_aip_iso14443A.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
        public static extern int ISO14443Ap3_Transceive(UIntPtr hr, UIntPtr ht, byte IsTxCRC, byte IsRxCRC, byte[] reqData, UInt32 reqLen, UInt32 nBytesTagWillRet, byte[] pRxBuffer, ref UInt32 nSize, UInt32 time);


        [DllImport("rfidlib_aip_iso14443A.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
        public static extern int ISO14443A_Connect(UIntPtr hr, byte tagType, byte[] uid, byte uidLen, ref UIntPtr ht);
