...
namespace InputStatusSample
{
    class rfidlib_reader
    {
        ...
        [DllImport("rfidlib_reader.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
        public static extern int RDR_GetIOPortIDs(UIntPtr hr, byte[] OutputIDs, ref UInt32 OutputSize, byte[] InputIDs, ref UInt32 InputSize);

        [DllImport("rfidlib_reader.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
        public static extern int RDR_GetInputStatus(UIntPtr hr, byte[] InputIO, byte[] Status, ref UInt32 nSize);

        [DllImport("rfidlib_reader.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
        public static extern int RDR_GetOutputStatus(UIntPtr hr, byte[] InputIO, byte[] Status, ref UInt32 nSize);
