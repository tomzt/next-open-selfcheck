...
namespace RFIDLIB
{
    class rfidlib_aip_iso15693
    {
        ...
        [DllImport("rfidlib_aip_iso15693.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
        public static extern int ISO15693_ParseTagDataReportEx(UIntPtr hTagReport, ref UInt32 aip_id, ref UInt32 tag_id, ref UInt32 ant_id, ref Byte dsfid, ref UInt16 rssi, ref UInt32 readcnt, Byte[] uid);
        [DllImport("rfidlib_aip_iso15693.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
        ...
        [DllImport("rfidlib_aip_iso15693.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
        public static extern int ISO15693_SetInventoryReadParam(UIntPtr hIso15693InvenParam, Byte mode, Byte mask);

        [DllImport("rfidlib_aip_iso15693.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
        public static extern int ISO15693_AddInventoryReadBlockArea(UIntPtr hIso15693InvenParam, UInt32 blkAddr, UInt32 numOfBlks);

        [DllImport("rfidlib_aip_iso15693.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
        public static extern int ISO15693_ParseInvenReadReport(UIntPtr hTagReport, ref Byte ant, ref Byte dsfid, Byte[] uid, ref UInt32 numOfBlocks, Byte[] blkData, ref UInt32 nSize);

        [DllImport("rfidlib_aip_iso15693.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
        public static extern UIntPtr ISO15693_CreateTAWriteMultipleTags(Byte isReadCheck, Byte antCnt, Byte[] antsel);

        [DllImport("rfidlib_aip_iso15693.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
        public static extern int ISO15693_AddOneTagToWriteMultipleTagsAccess(UIntPtr tagAccess, Byte[] uid);

        [DllImport("rfidlib_aip_iso15693.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
        public static extern int ISO15693_AddAreaToWriteMultipleTagsAccess(UIntPtr tagAccess, UInt32 blkAddr, UInt32 blkCnt, Byte[] blkData, UInt32 nSize);

        [DllImport("rfidlib_aip_iso15693.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
        public static extern int ISO15693_WriteMultipleTags(UIntPtr hr, UIntPtr tagAccess, Byte[] result, ref UInt32 nSize);


        //Inventory write command
        [DllImport("rfidlib_aip_iso15693.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
        public static extern UIntPtr ISO15693_CreateTAWriteAFI(UIntPtr hTagAccessSet, Byte afi);
        [DllImport("rfidlib_aip_iso15693.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
        public static extern UIntPtr NXPICODESLI_CreateTAEableEAS(UIntPtr hTagAccessSet);
        [DllImport("rfidlib_aip_iso15693.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
        public static extern UIntPtr NXPICODESLI_CreateTADisableEAS(UIntPtr hTagAccessSet);


        [DllImport("rfidlib_aip_iso15693.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
        public static extern UIntPtr ISO15693_CreateTAReadMultipleBlocks(UIntPtr hTagAccessSet, bool readSecSta, UInt32 blkAddr, UInt32 numOfBlksToRead);
        [DllImport("rfidlib_aip_iso15693.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
        public static extern int ISO15693_ParseReadMultiBlocksResult(UIntPtr tagAccess, ref UInt32 numOfBlksRead, byte[] bufBlocks, ref  UInt32 nSize);

        [DllImport("rfidlib_aip_iso15693.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
        public static extern UIntPtr ISO15693_CreateTAWriteMultipleBlocks(UIntPtr hTagAccessSet, UInt32 blkAddr, UInt32 numOfBlks, byte[] newBlksData, UInt32 bytesToWrite);
        [DllImport("rfidlib_aip_iso15693.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
        public static extern int ISO15693_ParseWriteMultipleBlocksResult(UIntPtr tagAccess);

       // [DllImport("rfidlib_aip_iso15693.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
      //  public static extern UIntPtr ISO15693_CreateTAWriteAFI(UIntPtr hTagAccessSet, byte afi);
        [DllImport("rfidlib_aip_iso15693.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
        public static extern int ISO15693_ParseWriteAFIResult(UIntPtr tagAccess);

   
        [DllImport("rfidlib_aip_iso15693.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
        public static extern int NXPICODESLI_ParseEableEASResult(UIntPtr tagAccess);

        [DllImport("rfidlib_aip_iso15693.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
        public static extern int NXPICODESLI_ParseDisableEASResult(UIntPtr tagAccess);


        [DllImport("rfidlib_aip_iso15693.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
         public static extern int  ISO15693_AddNewAccessTag(UIntPtr hTagSet, byte addrMode,byte []uid, bool inheritTagType, bool inheritAnt, bool inhertCmdSet);
