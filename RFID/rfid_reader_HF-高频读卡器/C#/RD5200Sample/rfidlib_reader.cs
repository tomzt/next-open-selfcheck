...
namespace RFIDLIB
{
    ...
    class rfidlib_reader
    {
        ...
        [DllImport("rfidlib_reader.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
        public static extern int RDR_ParseTagDataReportBlockData(UIntPtr hTagReport, byte[] buf, ref UInt32 nSize);
        [DllImport("rfidlib_reader.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
       ...
       public static extern int RDR_AddOneOutputOperation(UIntPtr hOperas,Byte outNo,Byte outMode,UInt32 outFrequency,UInt32 outActiveDuration ,UInt32 outInactiveDuration) ;
        ...
        [DllImport("rfidlib_reader.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
        public static extern int RDR_AddTagAccessToInvenParam(UIntPtr hInvenParam, UIntPtr hTagAccess);
        [DllImport("rfidlib_reader.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
        public static extern int RDR_ParseTagDataReportWriteResult(UIntPtr hTagReport, UIntPtr cmd, ref Byte result);

 [DllImport("rfidlib_reader.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
   public static extern   UIntPtr  CreateMultipleAccessTagSet(byte bDefaultAnt,byte bAllAnt,byte bAntDelay,UInt32 mAntDelayTime);

 [DllImport("rfidlib_reader.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
  public static extern int  RDR_SetLastATagTagType(UIntPtr hTagSet, UInt32 tagType);
         [DllImport("rfidlib_reader.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
  public static extern int  RDR_SetLastATagAntennas(UIntPtr hTagSet, byte []pAnt, byte antCnt);
         [DllImport("rfidlib_reader.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
        public static extern int RDR_AddLastATagAccessCommand(UIntPtr hTagSet, UIntPtr hCommand);


         [DllImport("rfidlib_reader.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
         public static extern int   RDR_AccessMultipleTags(UIntPtr hr, UIntPtr hTagSet);


        [DllImport("rfidlib_reader.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
         public static extern int  RDR_SeekAccessTag(UIntPtr hTagSet,UInt16 idx);


 [DllImport("rfidlib_reader.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
   public static extern  UIntPtr  RDR_GetTagAccessCommand(UIntPtr hTagSet, byte seekType);
