    ...
    class rfidlib_reader
    {
      ...
      public static extern int RDR_BuffMode_StopReportCollection(UIntPtr hr)  ;
        ...
        public static extern int RDR_ParseTagDataReportWriteResult(UIntPtr hTagReport, UIntPtr cmd, ref Byte result);
         ...
         [DllImport("rfidlib_reader.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
        public static extern int RDR_GetDeviceUniqueID(UIntPtr hr, byte[] pHUIDData, ref byte nSize);

        [DllImport("rfidlib_reader.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
         public static extern int RDR_UpdateUserSignature(UIntPtr hr, byte []pSig, byte nLen);

        [DllImport("rfidlib_reader.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
        public static extern int RDR_ReadUserSignature(UIntPtr hr, byte[] pSig, ref byte nSize);
