Namespace RFIDLIB
    Class rfidlib_aip_iso15693
        ...
        Public Declare Function STM24LR_PresentSectorPassword Lib "rfidlib_aip_iso15693.dll" (ByVal hr As UIntPtr, ByVal ht As UIntPtr, ByVal pwdnum As Byte, ByVal pwd As UInt32) As Integer

        Public Declare Function ISO15693_GetBlockSecStatus Lib "rfidlib_aip_iso15693.dll" (ByVal hr As UIntPtr, ByVal ht As UIntPtr, ByVal blkAddr As UInt32, ByVal numOfBlks As UInt32, ByRef bufBlkSecs As Byte(), ByVal nSize As UInt32, ByRef bytesSecRead As UInt32) As Integer


        Public Declare Function STM24LR_WriteSectorPassword Lib "rfidlib_aip_iso15693.dll" (ByVal hr As UIntPtr, ByVal ht As UIntPtr, ByVal pwdnum As Byte, ByVal new_pwd As UInt32) As Integer


        Public Declare Function STM24LR_LockSector Lib "rfidlib_aip_iso15693.dll" (ByVal hr As UIntPtr, ByVal ht As UIntPtr, ByVal sector_num As Byte, ByVal access_type As Byte, ByVal pwd_num_protect As Byte) As Integer

        Public Declare Function ISO15693_TransparentTransceive Lib "rfidlib_aip_iso15693.dll" (ByVal hr As UIntPtr, ByVal mode As Byte, ByVal isTxCRC As Byte, ByVal isRxCRC As Byte, ByVal reqData As [Byte](), ByVal reqLen As UInt32, ByVal nBytesTagWillRet As UInt32, ByRef pRxBuffer As [Byte](), ByRef nSize As UInt32, ByVal time As UInt32) As Integer
