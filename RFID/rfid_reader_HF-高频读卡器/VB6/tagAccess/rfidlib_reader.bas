...
Public Declare Function RDR_TagInventory Lib "rfidlib_reader.dll" (ByVal RdHwnd As Long, ByVal AIType As Byte, ByVal AntennaCount As Byte, ByRef AntennaIDs As Byte, ByVal InvenParamSpecList As Long) As Long
...
Public Declare Function RDR_GetReaderInfor Lib "rfidlib_reader.dll" (ByVal hr As Long, ByVal m_type As Byte, ByVal buffer As String, ByRef nSize As Long) As Long

Public Declare Function RDR_SetAcessAntenna Lib "rfidlib_reader.dll" (ByVal hr As Long, ByVal AntennaID As Byte) As Long
