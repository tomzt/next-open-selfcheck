...
RFID_DN_HANDLE RFIDLIB_API FM11NP04V_CreateTAReadReg(RFID_DN_HANDLE hTagAccessSet, BYTE regAddr);
err_t RFIDLIB_API FM11NP04V_ParseReadReg(RFID_DN_HANDLE tagAccess, BYTE regDat[]);
err_t RFIDLIB_API FM11NP04V_ReadReg(RFID_READER_HANDLE hr, RFID_TAG_HANDLE ht, BYTE regAddr, BYTE regDat[]);
RFID_DN_HANDLE RFIDLIB_API FM11NP04V_CreateTAWriteReg(RFID_DN_HANDLE hTagAccessSet, BYTE regAddr, BYTE regDLen, BYTE regDat[]);
err_t RFIDLIB_API FM11NP04V_WriteReg(RFID_READER_HANDLE hr, RFID_TAG_HANDLE ht, BYTE regAddr, BYTE regDLen, BYTE regDat[]);
RFID_DN_HANDLE RFIDLIB_API FM11NP04V_CreateTAReadMemory(RFID_DN_HANDLE hTagAccessSet, BYTE blkAddr);
err_t RFIDLIB_API FM11NP04V_ParseReadMemory(RFID_DN_HANDLE tagAccess, BYTE blkDat[]);
err_t RFIDLIB_API FM11NP04V_ReadMemory(RFID_READER_HANDLE hr, RFID_TAG_HANDLE ht, BYTE blkAddr, BYTE blkDat[]);
RFID_DN_HANDLE RFIDLIB_API FM11NP04V_CreateTAWriteMemory(RFID_DN_HANDLE hTagAccessSet, BYTE blkAddr, BYTE blkDat[]);
err_t RFIDLIB_API FM11NP04V_WriteMemory(RFID_READER_HANDLE hr, RFID_TAG_HANDLE ht, BYTE blkAddr, BYTE blkDat[]);
RFID_DN_HANDLE RFIDLIB_API FM11NP04V_CreateTAPWDAuth(RFID_DN_HANDLE hTagAccessSet, DWORD pwd);
err_t RFIDLIB_API FM11NP04V_PWDAuth(RFID_READER_HANDLE hr, RFID_TAG_HANDLE ht, DWORD pwd);
RFID_DN_HANDLE RFIDLIB_API FM11NT083V_CreateTAWriteFIFO(RFID_DN_HANDLE hTagAccessSet, BYTE FIFODat[], BYTE DLen);
err_t RFIDLIB_API FM11NT083V_WriteFIFO(RFID_READER_HANDLE hr, RFID_TAG_HANDLE ht, BYTE FIFODat[], BYTE DLen);
RFID_DN_HANDLE RFIDLIB_API FM11NT083V_CreateTAReadFIFO(RFID_DN_HANDLE hTagAccessSet, BYTE DLen);
err_t RFIDLIB_API FM11NT083V_ParseReadFIFO(RFID_DN_HANDLE tagAccess, BYTE blkDat[], BYTE *nRead);
err_t RFIDLIB_API FM11NT083V_ReadFIFO(RFID_READER_HANDLE hr, RFID_TAG_HANDLE ht, BYTE DLen, BYTE Dat[], BYTE *nRead);

RFID_DN_HANDLE RFIDLIB_API FM13HS01P_CreateTASetCfg(RFID_DN_HANDLE hTagAccessSet, BYTE setting);
err_t RFIDLIB_API FM13HS01P_SetCfg(RFID_READER_HANDLE hr, RFID_TAG_HANDLE ht, BYTE setting);
RFID_DN_HANDLE RFIDLIB_API FM13HS01P_CreateTALockCfg(RFID_DN_HANDLE hTagAccessSet);
err_t RFIDLIB_API FM13HS01P_LockCfg(RFID_READER_HANDLE hr, RFID_TAG_HANDLE ht);
RFID_DN_HANDLE RFIDLIB_API FM13HS01P_CreateTAGetCfg(RFID_DN_HANDLE hTagAccessSet);
err_t RFIDLIB_API FM13HS01P_ParseGetCfg(RFID_DN_HANDLE tagAccess, BYTE *lockSta, BYTE *setting);
err_t RFIDLIB_API FM13HS01P_GetCfg(RFID_READER_HANDLE hr, RFID_TAG_HANDLE ht, BYTE *lockSta, BYTE *setting);
