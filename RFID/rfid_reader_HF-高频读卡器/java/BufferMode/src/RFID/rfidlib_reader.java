...
public class rfidlib_reader
{
	...
	public native static int   RDR_SetSystemTime(long hr,int year,int month,int day,byte hours,byte minutes,byte sec);
	public native static int Bluetooth_Enum();
	
	public native static int Bluetooth_GetEnumItem(int idx, byte infType, char[] nameBuf, Integer nSize);
	...
	public native static int RDR_BuffMode_StartReportCollection(long hr);
	public native static int RDR_ParseTagDataReportRaw(long hTagReport,byte rawBuffer[],int nSize);
