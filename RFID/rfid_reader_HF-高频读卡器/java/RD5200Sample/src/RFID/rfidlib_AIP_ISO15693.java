...
public class rfidlib_AIP_ISO15693 {
	...
	*/
	...
	public native static int ISO15693_SetInventoryReadParam(
			long hIso15693InvenParam, 
			byte blkAddr,
			byte numOfBlks);
	
	public native static int ISO15693_AddInventoryReadBlockArea(long hIso15693InvenParam,long blkAddr,long numOfBlks);
	...
	public native static long NXPICODESLI_CreateTADisableEAS(long hTagAccessSet); 
	public native static long ISO15693_CreateTAWriteAFI(long hTagAccessSet,byte afival);
	
	public native static int  ISO15693_AddNewAccessTag(long hTagSet, byte addrMode,byte []uid, boolean inheritTagType, boolean inheritAnt, boolean inhertCmdSet);
	
	public native static long ISO15693_CreateTAReadMultipleBlocks(long hTagAccessSet,boolean readSecSta,long blkAddr,long numOfBlksToRead);	
	public native static int  ISO15693_ParseReadMultiBlocksResult(long tagAccess,Integer numOfBlksRead,byte []bufBlocks,Integer nSize);
	
	public native static long ISO15693_CreateTAWriteMultipleBlocks(long hTagAccessSet,long blkAddr,long numOfBlks,byte []newBlksData,long bytesToWrite);
	public native static int ISO15693_ParseWriteMultipleBlocksResult(long tagAccess);
	
	public native static long NXPICODESLI_CreateTAEableEAS(long hTagAccessSet);
	public native static int  NXPICODESLI_ParseEableEASResult(long tagAccess);
	
	public native static int   NXPICODESLI_ParseDisableEASResult(long tagAccess);


	public native static int ISO15693_ParseWriteAFIResult(long tagAccess); 
