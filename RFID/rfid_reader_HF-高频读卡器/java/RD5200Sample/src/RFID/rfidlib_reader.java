...
public class rfidlib_reader {
	...
	//public native static int RDR_GetAirInterfaceProtName(long hr,Integer  aiptype,char[] namebuf,Integer size);
	...
	public native static int  RDR_ParseTagDataReportBlockData(long hTagReport, byte[] buf, Integer nSize);

	public native static int RDR_AddTagAccessToInvenParam(long hIso15693InvenParam,long hTagaccess);
	
	public native static int RDR_ParseTagDataReportWriteResult(long hTagReport,long hWrite,Integer result);
	
	public native static long CreateMultipleAccessTagSet(byte bDefaultAnt, byte bAllAnt, byte bAntDelay, long mAntDelayTime);
	
	public native static int RDR_SetLastATagTagType(long hTagSet, long tagType);
	
	public native static int  RDR_SetLastATagAntennas(long hTagSet, byte []pAnt, byte antCnt);
	
	public native static int  RDR_AddLastATagAccessCommand(long hTagSet, long hCommand);
	
	public native static int  RDR_SeekAccessTag(long hTagSet, long idx);
	
	public native static long RDR_GetTagAccessCommand(long hTagSet, byte seekType);
	
	public native static int  RDR_AccessMultipleTags(long hr, long hTagSet);
