...
public class MainFrm extends JFrame implements Runnable
{
	...
	private JCheckBox checkEnable14443A = new JCheckBox("ISO14443A");
	private JCheckBox checkEnable14443B = new JCheckBox("ISO14443B");
	...
	JComboBox<String> cbxAntena = new JComboBox<String>();
	JButton btnSetAccessAntena = new JButton("Set access antena");
	...
	public MainFrm()
	{
		...
		JPanel panelAntena = new JPanel();
		panelAntena.setBorder(new TitledBorder(null, "Antena",
				TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		panelAntenaSelection.setBorder(new TitledBorder(null,
				"Antena Selection", TitledBorder.LEADING, TitledBorder.TOP,
				null, null));
		...
		btnSetAccessAntena.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent e)
			{
				byte antena = (byte) (Byte.parseByte(((String) cbxAntena
						.getSelectedItem()).split("#")[1]));

				int ret = rfidlib_reader.RDR_SetAcessAntenna(m_hr, antena);

				if (ret != 0)
				{

					JOptionPane.showMessageDialog(null,
							"Set Access Antenna Fail!err=" + ret);
				}
			...
			groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup()
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
						.addGroup(groupLayout.createSequentialGroup()
							.addComponent(panelTop, GroupLayout.PREFERRED_SIZE, 1100, GroupLayout.PREFERRED_SIZE)
							.addContainerGap(GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
						.addGroup(groupLayout.createSequentialGroup()
							.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING, false)
								.addComponent(panelUltralight, Alignment.LEADING, 0, 0, Short.MAX_VALUE)
								.addComponent(panel14443A, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
								.addComponent(panelInventory, Alignment.LEADING, 0, 0, Short.MAX_VALUE)
								.addComponent(panelIcodeSli, Alignment.LEADING, GroupLayout.PREFERRED_SIZE, 1070, Short.MAX_VALUE))
							.addContainerGap())))
		);
		groupLayout.setVerticalGroup(
			groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup()
					...
					.addComponent(panelIcodeSli, GroupLayout.DEFAULT_SIZE, 122, Short.MAX_VALUE)
					.addPreferredGap(ComponentPlacement.UNRELATED)
					.addComponent(panel14443A, GroupLayout.DEFAULT_SIZE, 125, Short.MAX_VALUE)
					.addPreferredGap(ComponentPlacement.UNRELATED)
						...
						.addGroup(gl_panelIcodeSli.createSequentialGroup()
							...
							.addGroup(gl_panelIcodeSli.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_panelIcodeSli.createSequentialGroup()
									...
									.addPreferredGap(ComponentPlacement.RELATED)
									.addComponent(btnGetsecState_iso15693))
								.addGroup(gl_panelIcodeSli.createSequentialGroup()
		...
		btnStartInventory.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent arg0)
			{
				...
				// List<String>strings=
				// listAntenaSelection.getSelectedValuesList();
		...
		checkEnable14443B.setEnabled(false);
		...
		gl_panelInventory.setHorizontalGroup(
			gl_panelInventory.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panelInventory.createSequentialGroup()
					.addContainerGap()
					.addComponent(tableInventory, GroupLayout.PREFERRED_SIZE, 300, GroupLayout.PREFERRED_SIZE)
					.addGap(10)
					...
					.addGroup(gl_panelInventory.createParallelGroup(Alignment.LEADING)
						.addComponent(checkEnable14443B)
						.addComponent(checkEnable14443A))
					.addPreferredGap(ComponentPlacement.RELATED)
					.addComponent(panelAntenaSelection, 0, 150, 150)
		...
		gl_panelInventory.setVerticalGroup(
			gl_panelInventory.createParallelGroup(Alignment.LEADING)
					...
					.addGroup(gl_panelInventory.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_panelInventory.createSequentialGroup()
							...
							.addGroup(gl_panelInventory.createParallelGroup(Alignment.BASELINE)
								.addComponent(tableInventory, GroupLayout.DEFAULT_SIZE, 101, Short.MAX_VALUE)
								.addGroup(gl_panelInventory.createSequentialGroup()
				...
				.addComponent(panelAntenaSelection, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
		);
		...
		GroupLayout gl_panelAntenaSelection = new GroupLayout(
				panelAntenaSelection);
		gl_panelAntenaSelection.setHorizontalGroup(gl_panelAntenaSelection
				.createParallelGroup().addComponent(spListAntenaSelection));
		gl_panelAntenaSelection.setVerticalGroup(gl_panelAntenaSelection
				.createParallelGroup().addComponent(spListAntenaSelection));

		spListAntenaSelection.setViewportView(listAntenaSelection);
		panelAntenaSelection.setLayout(gl_panelAntenaSelection);
		...
		gl_panelTop.setHorizontalGroup(gl_panelTop
				.createSequentialGroup()
				.addComponent(panel, GroupLayout.PREFERRED_SIZE, 800,
						GroupLayout.PREFERRED_SIZE)
				.addComponent(panelAntena, GroupLayout.PREFERRED_SIZE, 400,
						GroupLayout.PREFERRED_SIZE)

		);

		gl_panelTop.setVerticalGroup(gl_panelTop
				.createParallelGroup()
				.addComponent(panel, GroupLayout.PREFERRED_SIZE,
						GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
				.addComponent(panelAntena, GroupLayout.PREFERRED_SIZE,
						GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE));

		panelTop.setLayout(gl_panelTop);

		JLabel lblAntenaNum = new JLabel("Antena Num:");
		// JComboBox<String> cbxAntena=new JComboBox<String>();

		GroupLayout gl_panelAntena = new GroupLayout(panelAntena);

		gl_panelAntena.setHorizontalGroup(gl_panelAntena.createParallelGroup()
				.addComponent(lblAntenaNum)
				.addComponent(cbxAntena, 50, 50, 100)
				.addComponent(btnSetAccessAntena));

		gl_panelAntena.setVerticalGroup(gl_panelAntena.createSequentialGroup()
				.addComponent(lblAntenaNum)
				.addComponent(cbxAntena, 20, 30, 100)
				.addComponent(btnSetAccessAntena));

		panelAntena.setLayout(gl_panelAntena);
	...
	private void LoadLibrary()
	{
		...
		rfidlib_aip_iso14443B.LoadLib(libPath, osType, arType);
...
//		String str1="63233F98BB9E79201DE00000";
//
//		byte[] reqbyt=gFunction.decodeHex(str1);
//		byte[] resbyt=new byte[6];
//		Long nszie=new Long(6);
//		nret=rfidlib_AIP_ISO15693.ISO15693_TransparentTransceive(hrOut.longValue(),(byte)0
//				,(byte)1,(byte)1
//				,reqbyt,reqbyt.length,4,resbyt,nszie,0);
		...
		cbxAntena.removeAllItems();
		int countAntena = rfidlib_reader.RDR_GetAntennaInterfaceCount(m_hr);

		String[] str = new String[countAntena];

		for (int i = 0; i < countAntena; i++)
		{
			str[i] = "Antenna#" + (i + 1);

			cbxAntena.addItem(str[i]);
		}

		listAntenaSelection.setListData(str);

		listAntenaSelection.setSelectionModel(new DefaultListSelectionModel()
		{
			@Override
		...
		listAntenaSelection.setCellRenderer(cell);

		if (str.length > 1)
		{
			listAntenaSelection.setEnabled(true);
			cbxAntena.setEnabled(true);
		} else
		{
			listAntenaSelection.setEnabled(false);
			cbxAntena.setEnabled(false);
		}
	...
	public void run()
	{
		...
		boolean b_iso14443b = checkEnable14443B.isSelected();
		if (InvenParamSpecList != 0)
		{
			...
			if (b_iso14443b)
			{
				rfidlib_aip_iso14443B.ISO14443B_CreateInvenParam(
						InvenParamSpecList, (byte) 0, (byte) 0, (byte) 0);
			}
		}
		...
		while (b_inventoryFlg)
		{
			...
			nret = rfidlib_reader.RDR_TagInventory(m_hr, newAI, Antennacount,
			...
			while (dnhReport != 0)
			{
				...
				if (b_iso14443b)
				{
					...
					Integer tag_id = new Integer(0);
					Integer ant_id = new Integer(0);
					Integer metaFlag = new Integer(0);
					byte[] tagData = new byte[128];
					Integer tagDataLen = new Integer(tagData.length);
					nret = rfidlib_aip_iso14443B.ISO14443B_ParseTagDataReport(
							dnhReport, aip_id, tag_id, ant_id, metaFlag,
							tagData, tagDataLen);
					if (nret == 0)
					{
						String sUid = gFunction.encodeHexStr(tagData, tagDataLen.intValue());
						AddTagToTable(aip_id, tag_id, sUid);
					}
				}
				dnhReport = rfidlib_reader.RDR_GetTagDataReport(m_hr,
	...
	private void EnableAllCtr(boolean isOpen)
	{
		...
		checkEnable14443B.setEnabled(isOpen);
	...
	private void EnableInventoryCtr(boolean isInventory)
	{
		...
		checkEnable14443B.setEnabled(!isInventory);
	}
